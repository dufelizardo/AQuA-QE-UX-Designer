...
- Toda recomendação de acessibilidade referencia um critério WCAG 2.2 específico e usa linguagem de recomendação, nunca certificação (GR-UX-2).
...
- **Certificação de acessibilidade** — "este fluxo está em conformidade com WCAG 2.2 AA" apresentado como fato (viola GR-UX-2).
